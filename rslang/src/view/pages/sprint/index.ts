  ...
  createSprintPage() {
    ...
    <div class="sprint-main">
      ...
      <div class="promo">
          ...
          <h5>Trains the skill of quick translation from English into Russian. <br> You need to choose whether the translation matches the suggested word.</h5>
          <h5>you can select answers from keyboard right and left</h5>
        </div>
